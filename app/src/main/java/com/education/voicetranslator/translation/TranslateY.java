...
import com.education.voicetranslator.mic.ApiKeysYandex;

/**
 * Makes calls to the Yandex machine translation web service API
 */
public final class TranslateY extends YandexTranslatorAPI {
	 ...
	 *             on error.
	 */
	public static String execute(final String text, final LanguageY from,
			final LanguageY to) throws Exception {
	...
	public static String execute(final String text, final LanguageY to)
			throws Exception {
		validateServiceState(text);
		final String params = PARAM_API_KEY
				+ URLEncoder.encode(apiKey, ENCODING) + PARAM_LANG_PAIR
	...
	public static void main(String[] args) {
		try {
			YandexTranslatorAPI.setKey(ApiKeysYandex.YANDEX_API_KEY);
			String translation = TranslateY.execute(
					"The quick brown fox jumps over the lazy dog.",
					LanguageY.ENGLISH, LanguageY.SPANISH);
